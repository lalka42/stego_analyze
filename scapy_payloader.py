...
#window
 ...
 pktcp1 = IP(src="10.98.14.135", dst="91.197.194.73", len=length) / TCP()
 pktcp2 = IP(src="10.98.14.135", dst="91.197.194.73", tos=tos) / TCP()
 pktcp3 = IP(src="10.98.14.135", dst="91.197.194.73", id=ident) / TCP()
 pktcp4 = IP(src="10.98.14.135", dst="91.197.194.73", len=length, tos=tos) / TCP()
 pktcp5 = IP(src="10.98.14.135", dst="91.197.194.73", len=length, id=ident) / TCP()
 pktcp6 = IP(src="10.98.14.135", dst="91.197.194.73", tos=tos, id=ident) / TCP()
 pktcp7 = IP(src="10.98.14.135", dst="91.197.194.73", len=length, tos=tos, id=ident) / TCP()
